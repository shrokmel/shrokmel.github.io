...
### Unwrapped
Given the size of the box, we can also directly compute the distances according to the minimum image convention, _without_ wrapping the particles within the unit cell. This is done here in C++ in the folloing manner:
